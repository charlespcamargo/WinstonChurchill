 ...
 * Improvements by Brown(just navigation icons modified)
...
!function( $ ) {
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="icon-angle-left"/></th>'+ //icon modifed by Brown.
								'<th colspan="5" class="switch"></th>'+
								'<th class="next"><i class="icon-angle-right"/></th>'+//icon modifed by Brown.
							'</tr>'+
						'</thead>',
