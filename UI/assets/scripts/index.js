                ...
                $("#site_statistics").bind("plothover", function (event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint != item.dataIndex) {
                            ...
                            showTooltip('24 Jan 2017', item.pageX, item.pageY, item.series.label + " of " + x + " = " + y);
                        }
                    } else {
                        $("#tooltip").remove();
                        previousPoint = null;
                ...
                $("#site_activities").bind("plothover", function (event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
                            ...
                            var x = item.datapoint[0].toFixed(2),
                                y = item.datapoint[1].toFixed(2);
                            showTooltip('24 Feb 2017', item.pageX, item.pageY, x);
                        }
                    }
                });
        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    text: 'Brown is a brand new Responsive Admin Dashboard Template you have always been looking for!',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Buy Brown!',
                    // (string | mandatory) the text inside the notification
                    text: 'Brown comes with a huge collection of reusable and easy customizable UI components and plugins. Buy Brown today!',
                    // (string | optional) the image to display on the left
                    image: './assets/img/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    position: 'top-left',
                    // (string | mandatory) the heading of the notification
                    title: 'Customize Brown!',
                    // (string | mandatory) the text inside the notification
                    text: 'Brown allows you to easily customize the theme colors and layout settings.',
                    // (string | optional) the image to display on the left
